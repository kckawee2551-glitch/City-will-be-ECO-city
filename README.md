...
<head>
    ...
    <title>EcoCity: 1000 MW Hardcore</title>
...
<body>
    ...
    <div id="welcome-screen" class="modal-overlay">
        <div class="modal-content">
            ...
            <p>ภารกิจจำกัดเวลา <b>3 นาที</b><br><br><b>เป้าหมาย:</b> สร้างพลังงานให้ถึง <b>1,000 MW</b><br><b>เงื่อนไขมลพิษ:</b> ห้ามแตะ <b>100%</b> (ถ้าถึง 100% แพ้ทันที! โรคระบาดเพิ่มมลพิษ 20%)</p>
    ...
    <div class="container" id="game-container">
        ...
        <div class="subtitle">เป้าหมาย: 1,000 MW ใน 3 นาที | มลพิษสูงสุด 100% (แตะ 100% แพ้ทันที)</div>
        ...
        <div class="main-grid">
            <div class="panel">
                ...
                <div class="button-full">
                    <button id="btn-filter" class="filter-btn" onclick="buildPlant('filter')">🌿 ระบบกรองคาร์บอน (400G)<br><small>ลดมลพิษ 15% | เสียพลังงาน -10MW</small></button>
                </div>
                <div class="button-full">
            ...
            <div class="panel">
                ...
                <div id="log" class="log">[ระบบ] โหมด 1,000 MW เริ่มขึ้นแล้ว! ระวังมลพิษถึง 100% จะแพ้ทันที!</div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function buildPlant(type) {
            ...
            if (type === 'coal') {
                ...
                if (money >= 400) {
                    money -= 400;
                    pollution = Math.max(0, pollution - 15); // [แก้ไข]: ปรับเพิ่มการลดมลพิษจาก 10 เป็น 15%
                    energy = Math.max(0, energy - 10);
                    logMessage("🌿 เปิดใช้งานระบบกรองคาร์บอนสำเร็จ! (มลพิษลดลง 15%, เสียพลังงาน 10 MW)", "success");
                } else {
        ...
        function checkGameStatus() {
            ...
            // [แก้ไข]: เพิ่มเงื่อนไขเช็คว่าถ้ามลพิษแตะ 100% แพ้ทันที
            if (pollution >= 100) {
                triggerGameOver("มลพิษในเมืองพุ่งสูงถึง 100% ประชาชนอพยพหนีหมด เมืองล่มสลาย!");
            } else if (money < 0) {
        ...
        setInterval(function() {
            ...
            if (gameLoopCounter >= 5) { 
                ...
                if (eventChance < eventThreshold1) {
                    ...
                    logMessage(`🦠 เกิดโรคระบาดและหมอกควันพิษหนาแน่น! มลพิษพุ่งพรวด +${diseasePollution}%`, "danger");
                    showObstaclePopup("🦠", `โรคระบาดและหมอกควันพิษ! มลพิษพุ่ง +${diseasePollution}%`);
                }
